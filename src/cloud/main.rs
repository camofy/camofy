...
pub fn router(app: App) -> Router {
    Router::new()
        ...
        .route(
            "/api/bundles/:id/subscription-links",
            get(api::subscription_links),
        )
        .route(
            "/api/bundles/:id/subscription-links/reset",
            post(api::reset_subscription),
        )
        .route(
            "/api/bundles/:id/subscription-links/:hash",
            axum::routing::delete(api::revoke_subscription),
        )
